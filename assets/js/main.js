...
(function () {
  ...
  (function sgHub() {
    ...
    var FEATURED_VENUES = [
      // ---------- PRIVATE HALLS ----------
      { id: 'wyse', name: 'Wyse Active Hub', area: 'Jurong East', region: 'West', type: 'private', addr: '1 Venture Avenue, #03-01, Perennial Business City, S608521', meta: 'Air-conditioned \u00b7 32 courts (SG\u2019s largest)', hours: 'Mon–Fri 10:00–22:00 · Sat–Sun 08:00–22:00', hoursSource: 'https://thesmartlocal.com/read/wyse-active-hub-badminton-courts-singapore/', book: 'https://wyseactivehub.rezerv.co/', bookLabel: 'Book on Rezerv', bookNote: 'Court booking runs on Rezerv (also in the Dungeon app).', elever: true },
      { id: 'fernvale', name: 'Fernvale Village', area: 'Sengkang', region: 'North-East', type: 'private', addr: '61 Fernvale Link, S799956', meta: 'Air-conditioned \u00b7 badminton & pickleball', hours: 'Daily 07:00–02:00', hoursSource: 'https://stampede.sg/fernvale-village-the-badminton-village/about', book: 'https://booking.fernvalevillage.com/', bookLabel: 'Book a court', elever: true },
      { id: 'arina', name: 'The Sports Arina @ Jalan Kayu', area: 'Sengkang West', region: 'North-East', type: 'private', addr: '28 Fernvale Road, S799951', meta: 'Air-conditioned \u00b7 4 badminton courts', hours: 'Daily 08:00–23:00', hoursSource: 'https://playtomic.com/clubs/tsa-jalan-kayu', book: 'https://playtomic.com/clubs/tsa-jalan-kayu', bookLabel: 'Book on Playtomic', bookNote: 'Bookings are handled in the Playtomic app.' },
      { id: 'sbhsims', name: 'Singapore Badminton Hall (SBH @ Sims)', area: 'Geylang', region: 'East', type: 'private', addr: '1 Lorong 23 Geylang, S388352', meta: '16 courts + VIP \u00b7 Tel 6744 4111', hours: 'Mon–Fri 08:00–00:00 · Sat, Sun & PH 07:00–00:00', hoursSource: 'https://singaporebadmintonhall.com/contact-us/#location', book: 'https://playtomic.com/clubs/sbh-sims', bookLabel: 'Book on Playtomic', bookNote: 'SBH moved court booking to Playtomic in Aug 2025.', elever: true },
      { id: 'sbhexpo', name: 'SBH East Coast @ Expo', area: 'Changi', region: 'East', type: 'private', addr: 'Singapore Expo, Carpark J, Changi South Ave 1, S486150', meta: 'SG\u2019s largest private hall \u00b7 22+ courts', hours: 'Daily 08:00–00:00', hoursSource: 'https://singaporebadmintonhall.com/expo/', book: 'https://playtomic.com/clubs/sbh-east-coast-expo', bookLabel: 'Book on Playtomic', bookNote: 'SBH moved court booking to Playtomic in Aug 2025.', elever: true },
      { id: 'obapasirris', name: 'OBA Arena @ Pasir Ris', area: 'Pasir Ris', region: 'East', type: 'private', addr: '3A Pasir Ris Drive 6, S519422', meta: 'Academy-operated arena', hours: 'Mon–Fri 09:00–22:00 · Sat–Sun 08:00–22:00', hoursSource: 'https://www.optimumbadmintonacademy.com/court-booking', book: 'https://www.optimumbadmintonacademy.com/', bookLabel: 'Booking info' },
      { id: 'obapunggol', name: 'OBA Arena @ Punggol', area: 'Punggol', region: 'North-East', type: 'private', addr: '11 Northshore Drive, S828670', meta: 'Covered arena', hours: 'Mon–Fri 09:00–22:00 · Sat–Sun 08:00–22:00', hoursSource: 'https://www.optimumbadmintonacademy.com/court-booking', book: 'https://www.optimumbadmintonacademy.com/court-booking', bookLabel: 'Book a court', bookNote: 'Court hire is arranged through Optimum Badminton Academy.' },
      { id: 'citysprouts', name: 'City Sprouts @ Bedok', area: 'Bedok', region: 'East', type: 'private', addr: '200 Bedok North Avenue 1', meta: 'Community hub \u00b7 courts by XY Badminton', hours: 'Venue: daily 09:00–23:00 · tenant hours may vary', hoursSource: 'https://citysprouts.com.sg/pages/city-sprouts-bedok', book: 'https://xyacademy.rezerv.co/', bookLabel: 'Book on Rezerv' },
      { id: 'kff', name: 'KFF Badminton Arena / Singapore Badminton Stadium', area: 'Geylang', region: 'East', type: 'private', addr: '100 Guillemard Road, S399718', meta: 'Historic SBA venue \u00b7 12 courts (reopened 2025)', hours: 'Daily 07:00–23:00 · Fri–Sat late-night slots to 02:00', hoursSource: 'https://booking.singaporebadminton.org.sg/pricing-information', book: 'https://booking.singaporebadminton.org.sg/', bookLabel: 'Book a court', bookNote: 'Run by the Singapore Badminton Association on its own booking site.', elever: true },
      { id: 'smash', name: 'Smash Arena', area: 'Joo Koon', region: 'West', type: 'private', addr: '511 Upper Jurong Road, D\u2019Arena, Blk B L2, S638366', meta: '9 doubles + 1 single \u00b7 Taraflex flooring', hours: 'Daily 08:00–02:00', hoursSource: 'https://smasharena.sg/pricing', book: 'https://booking.smasharena.sg/', bookLabel: 'Book a court' },
      ...
      { id: 'bidadari', name: 'Bidadari Community Club', area: 'Bidadari', region: 'Central', type: 'cc', addr: '11 Bidadari Park Drive, S367905', meta: '\u00c9lever class venue \u00b7 community club', hours: 'Public booking bands: 09:30–12:30 · 12:30–17:30 · 17:30–21:30', hoursSource: 'https://www.onepa.gov.sg/cc/bidadari-cc', book: 'https://wa.me/6589214221', bookLabel: 'Book an \u00c9lever class', bookNote: 'CC courts are balloted on OnePA; Élever classes are booked with us.', altBook: 'https://www.onepa.gov.sg/facilities/search?facility=BADMINTON%20COURTS', altBookLabel: 'Public courts on OnePA', elever: true },
      { id: 'scgs', name: "Singapore Chinese Girls' School", area: 'Novena', region: 'Central', type: 'elever', addr: '190 Dunearn Road, S309437', meta: '\u00c9lever class venue \u00b7 school hall', hours: 'Élever class access: Sun 15:00–17:00 · no public court hire', hoursSource: 'classes.html#schedule', book: 'https://wa.me/6589214221', bookLabel: 'Book an \u00c9lever class', bookNote: 'School hall — not open for public court hire. Élever classes run here.', elever: true }
    ];

    var officialVenues = Array.isArray(window.ACTIVESG_BADMINTON_VENUES)
      ? window.ACTIVESG_BADMINTON_VENUES
      : [];
    var classVenueIds = {
      'activesg-cantonment-primary-school-hall': true,
      'activesg-north-vista-primary-school-hall': true
    };
    officialVenues.forEach(function (venue) {
      if (classVenueIds[venue.id]) venue.elever = true;
    });
    var VENUES = FEATURED_VENUES.concat(officialVenues);
    var activeSgCount = officialVenues.filter(function (venue) { return venue.type === 'activesg'; }).length;
    var dusCount = officialVenues.filter(function (venue) { return venue.type === 'dus'; }).length;
    var officialCount = officialVenues.length;
    ...
    var statActiveSg = document.getElementById('statActiveSg');
    if (statActiveSg) statActiveSg.textContent = activeSgCount;
    var statDus = document.getElementById('statDus');
    if (statDus) statDus.textContent = dusCount;
    var statOfficial = document.getElementById('statOfficial');
    if (statOfficial) statOfficial.textContent = officialCount;
    ...
    if (filtersEl) {
      ...
      if (initialType) {
        filtersEl.querySelectorAll('.fdrop[data-group="type"] input').forEach(function (box) {
          box.checked = initialType === 'official'
            ? box.value === 'activesg' || box.value === 'dus'
            : box.value === initialType;
        });
        pickedTypes = readDrop('type');
      }
      syncFilterChrome();
    ...
    if (localEventsMount) {
      localEventsMount.innerHTML = LOCAL_EVENTS.length
        ...
        : '<p class="hub__empty">No local tournaments listed right now. ' +
          ...
          'Check the SBA calendar &rsaquo;</a></p>';
    }
