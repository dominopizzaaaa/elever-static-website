...
(function () {
  ...
  var UI = {
    en: {
      ...
      'groups.casualLink1': '<a href="https://racketratings.net/" target="_blank" rel="noopener">Racket Ratings</a> — rated players and sessions',
    ...
    zh: {
      ...
      'hub.hint': '在新加坡，没有一个地方能查到所有打球场地 — 于是我们把它做了出来。浏览球馆、了解如何订场，并找到一起打球的伙伴。新手？先到 <a href="https://racketratings.net/" target="_blank" rel="noopener">Racket Ratings</a> 看看你的水平。<strong>不只是一家学院 — 更是新加坡羽球之家。</strong>',
      'hub.tabHalls': '去哪打球',
      'hub.tabBook': '如何订场',
      'hub.tabGroups': '球友与评级',
      ...
      'groups.casualLink1': '<a href="https://racketratings.net/" target="_blank" rel="noopener">Racket Ratings</a> — 有评级的球员与球局',
